...
function render(slot, ad) {
  ...
  /* Header line: sells the slot. A real mailto, because inviting contact and
     then navigating to an advertiser would be a dark pattern. The subject
     carries the unit size so an enquiry says which slot it is about. */
